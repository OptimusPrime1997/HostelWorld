                    ...
                    <div class="d-table col-12 width-full py-4 border-bottom border-gray-light">
                        ...
                        <div class="d-table-cell col-9 v-align-top pr-3">
                            <a href="/14dtj" class="d-inline-block no-underline mb-1">
                                <span class="f4 link-gray-dark">name-AllOrder</span>
                ...
                <%--</div>--%>
                    ...
                    <div class="display-container" id="Reserved">
                        ...
                        <div class="d-table col-12 width-full py-4 border-bottom border-gray-light">
                            ...
                            <div class="d-table-cell col-9 v-align-top pr-3">
                                <a href="/14dtj" class="d-inline-block no-underline mb-1">
                                    <span class="f4 link-gray-dark">name-Reserved</span>
                                    <span class="link-gray pl-1">id</span>
                                </a>
                                <p class="text-gray text-small">other</p>
                    ...
                    <div class="display-container" id="Checked">
                        ...
                        <div class="d-table col-12 width-full py-4 border-bottom border-gray-light">
                            ...
                            <div class="d-table-cell col-9 v-align-top pr-3">
                                <a href="/14dtj" class="d-inline-block no-underline mb-1">
                                    <span class="f4 link-gray-dark">name-Checked</span>
                                    <span class="link-gray pl-1">id</span>
                                </a>
                                <p class="text-gray text-small">other</p>
                    ...
                    <div class="display-container" id="Completed">
                        ...
                        <div class="d-table col-12 width-full py-4 border-bottom border-gray-light">
                            ...
                            <div class="d-table-cell col-9 v-align-top pr-3">
                                <a href="/14dtj" class="d-inline-block no-underline mb-1">
                                    <span class="f4 link-gray-dark">name-Complete</span>
                                    <span class="link-gray pl-1">id</span>
                                </a>
                                <p class="text-gray text-small">other</p>
