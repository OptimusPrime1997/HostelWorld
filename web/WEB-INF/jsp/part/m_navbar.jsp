    ...
    <img class="logo" src="../../img/logo.png">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav addMargin">
                <li>
                    <a href="<%=response.encodeURL(request.getContextPath()+"/CheckInfoServlet")%>">信息审批</a>
                </li>
                <li>
                    <a href="<%=response.encodeURL(request.getContextPath()+"/PayoffServlet")%>">酒店结算</a>
                </li>
                <li>
                    <a href="<%=response.encodeURL(request.getContextPath()+"/ManageInfoServlet")%>">营业信息</a>
                </li>
                <%--<li>
                    <a href="#">个人中心</a>
                </li>--%>
